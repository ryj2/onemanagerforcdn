...
$constStr = [
    ...
    'EnvironmentsDescription' => [
        'en-us' => [
            ...
            'sitename' => 'sitename',
            'cdnEnabled' => 'Enable CDN acceleration for file downloads, 0 or 1',
            'cdnProvider' => 'CDN provider: cloudflare, edgeone, or custom',
            'cdnWorkerUrl' => 'URL of your CDN Worker (e.g., https://worker.domain.workers.dev for Cloudflare)',
            'cdnForLargeFile' => 'Use CDN only for files larger than X MB, 0 = use CDN for all files',
        ],
        'zh-cn' => [
